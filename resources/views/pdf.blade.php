        ...
        <table width="100%">
            <tr>
                ...
                <td width="40%" style="text-align: right; "><span style="font-weight: bold; font-size: 14pt;">الفلسطينية
                        للصرافة
                    </span><br />شارع عمر المختار<br />غزة<br />بجوار الجرجاوي للعصائر<br />
                    <span>&#9742;</span>
                    <span dir="ltr">
                        059 21 58845 15
                    </span>
                ...
                <td width="40%" style="text-align: left; "><span
                        style="font-weight: bold; font-size: 14pt;">PalExchange
