...
return [
    ...
    'attributes' => [
        ...
        'final_received_amount' => 'القيمة المستلمة النهائية',
        'delivering_type' => 'نوع الحوالة',
        'sender_party_id' => 'المرسل',
        'received_amount' => 'المبلغ للتسليم',
        'to_send_amount' => 'المبلغ للإرسال',
        'received_currency_id' => 'عملة الإرسال',
        'delivery_currency_id' => 'عملة التسليم',
        // 'reference_currency_id' => 'required|exists:currencies,id',
        'exchange_rate_to_reference_currency' => 'معامل التحويل للدولار',
        'exchange_rate_to_delivery_currency' => 'معامل التحويل لعمبة التسليم',
        'office_id' => 'المكتب',
        'office_currency_id' => 'عملة المكتب',
